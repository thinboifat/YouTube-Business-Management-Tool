                        ...
                        <div class="panel-heading">
                            <div class="row">
                                ...
                                <div class="col-xs-9 text-right">
                                    ...
                                    <div>Daily Subscriber Count</div>
                                </div>
                            </div>
                        </div>
                        <a href="#">
            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <i class="fa fa-bar-chart-o fa-fw"></i> Channel Views (last 30 days)
                ...
                <div class="col-lg-4">
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                ...
                                <ul class="progressUL" id="currentProjects">
                                   <!--getProjectsStatus-->
                                    <!--<li>
                                        <a class="text-center" href="#">
