                    ...
                    <div class="panel panel-red">
                        <div class="panel-heading">
                            <div class="row">
                                ...
                                <div class="col-xs-9 text-right">
                                    <div class="huge"><?php echo $completeProjects; ?></div>
                                    <div>Completed</div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="col-lg-10 col-lg-offset-1">
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        ...
                        <i class="fa fa-clock-o fa-fw"></i> Project Name
                            ...
                            <li>
                                ...
                                <div class="timeline-panel">
                                    <div class="timeline-heading">
                                        ...
                                        <p>
                                            <small class="text-muted"><i class="fa fa-clock-o"></i> 11 hours ago</small>
                                        </p>
                                    </div>
                                    <div class="timeline-body fillerText">
                                        <p>New Project - M65 Review <br /> Type: Review / Mouse <br /> Description: Review of the Corsair M65 Mouse
